...
##################### Inference #####################
output_image_folder = f"./distrifuser_images/distrifuser_controlnets_{serve_args.num_controlnets}_loras_{serve_args.num_loras}"
if not os.path.isdir(output_image_folder):
    os.mkdir(output_image_folder)


prompts = read_prompts(num_prompts=20)
