...
try:
    ...
    _import_structure["pipeline_stable_diffusion_xl_controlnet"] = ["StableDiffusionXLPipelineControlNet"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_stable_diffusion_xl_controlnet import StableDiffusionXLPipelineControlNet
